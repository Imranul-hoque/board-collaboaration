...
export const ColorPicker = ({ onChange }: ColorPickerProps) => {
  return (
    <div
      className="flex flex-wrap gap-1 items-center max-w-[170px] pr-2 mr-2 border-r border-neutral-200"
    >
...
const ColorButton = ({ onClick, color }: ColorButtonProps) => {
  return (
    <button
      className="flex items-center justify-center h-8 w-9 hover:opacity-75 transition"
